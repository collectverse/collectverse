CREATE DATABASE  IF NOT EXISTS `collectverse` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `collectverse`;
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: collectverse
-- ------------------------------------------------------
...
CREATE TABLE `publications` (
  ...
  CONSTRAINT `publications_ibfk_1` FOREIGN KEY (`owneruser`) REFERENCES `users` (`id`)
...
-- Dump completed on 2023-10-23  0:24:48
