...
async function createSchema() {
    try {
        ...
        (9.99, 'Complemento', 'Pacote de 100 Tokens', 'Adquira 100 Tokens, a moeda digital do site, que pode ser usada para obter colecionáveis exclusivos e acessórios digitais. Utilize seus Tokens para personalizar sua experiência e desbloquear conteúdos adicionais, como skins, avatares, ou emblemas especiais na loja virtual!', 'token_pack_100.jpg', '["Complemento", "Pacote"]', '{"tokens": 100}', NOW(), NOW()),
        
        (19.99, 'Complemento', 'Pacote de 250 Tokens', 'Compre 250 Tokens, a moeda virtual do site, e expanda seu inventário com colecionáveis premium. Use seus Tokens para adquirir itens limitados na loja, aumentar seu status de jogador e desbloquear conteúdo exclusivo para aprimorar seu perfil e participação em eventos!', 'token_pack_250.jpg', '["Complemento", "Pacote"]', '{"tokens": 250}', NOW(), NOW()),
        
        (49.99, 'Pacote', 'Pacote de 700 Tokens', 'Obtenha 700 Tokens, perfeitos para usuários que desejam aproveitar ao máximo a coleção de itens raros. Com esses Tokens, você pode comprar conjuntos completos de colecionáveis, participar de promoções exclusivas e garantir seu lugar entre os melhores jogadores da comunidade!', 'token_pack_700.jpg', '["Complemento", "Pacote"]', '{"tokens": 700}', NOW(), NOW()),
        
        (99.99, 'Pacote', 'Pacote de 1500 Tokens', 'Garanta 1500 Tokens e aproveite uma experiência de compra sem limites! Esta oferta permite que você adquira os itens mais cobiçados da loja, incluindo pacotes temáticos, acessórios exclusivos, e muito mais. Torne-se um colecionador lendário e destaque-se na comunidade!', 'token_pack_1500.jpg', '["Complemento", "Pacote"]', '{"tokens": 1500}', NOW(), NOW()),
        
        (149.99, 'Complemento', 'Pacote de 3000 Tokens', 'Adquira 3000 Tokens, ideais para quem busca uma experiência completa no site. Use seus Tokens para comprar tudo o que há de melhor e raro: colecionáveis exclusivos, avatares personalizados, passes de temporada e conteúdo adicional! Seja um dos maiores colecionadores do site!', 'token_pack_3000.jpg', '["Complemento", "Pacote", "Pacote"]', '{"tokens": 3000}', NOW(), NOW());`
